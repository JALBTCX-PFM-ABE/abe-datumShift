  ...
  QWizardPage (parent)
{
  ...
  progress->fbar->setWhatsThis (tr ("Progress of input file filtering"));
  ...
  progress->obox = new QGroupBox (tr ("Total file processing progress"), this);
  ...
  progress->obar->setWhatsThis (tr ("Progress of the processing of all of the input data files."));
