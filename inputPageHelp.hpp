...
QString dirBrowseText = 
  inputPage::tr ("This button allows you to select multiple input files by specifiying a top level directory.  Using "
                 ...
                 "<b>WARNING: CHARTS *.hof LIDAR files that have a filename like this - "
                 "03DS03044_012_031205_0028_TA_05272.hof will not be "
...
QString inputFilesText = 
  inputPage::tr ("This is a list of all files to which the datum correction will be applied.  There is limited text editor "
